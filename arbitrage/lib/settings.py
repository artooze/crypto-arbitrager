...
HAOBTC_API_URL = {
                  'host' :'api.bixin.com',
                  'trade':'https://api.bixin.com/exchange/api_hermes/v1/trade',
                  'cancel_order':'https://api.bixin.com/exchange/api_hermes/v1/cancel_order',
                  'order_info':'https://api.bixin.com/exchange/api_hermes/v1/order_info',
                  'orders_info':'https://api.bixin.com/exchange/api_hermes/v1/orders_info',
                  'history_info':'https://api.bixin.com/exchange/api_hermes/v1/history_info',
                  'account_info':'https://api.bixin.com/exchange/api_hermes/v1/account_info',
                  'ticker':'https://api.bixin.com/exchange/api_hermes/v1/ticker' ,
                  'depth':'https://api.bixin.com/exchange/api_hermes/v1/depth',
                  'batch_trade':'https://api.bixin.com/exchange/api_hermes/v1/batch_trade',
                  'cancel_all':'https://api.bixin.com/exchange/api_hermes/v1/cancel_all',
                  'cancel_list':'https://api.bixin.com/exchange/api_hermes/v1/cancel_list',
                  'fast_ticker':'https://api.bixin.com/api/v1/price/cny',
                  }
